...
$('.row').css({"border": "2px solid black", "padding": "20px"});
...
$('p em:last-child').css({'color': 'green'});
...
console.log($("input[checked][type='checkbox']"));
...
$('.mbox:eq(-1) div:eq(0)').css({"float": "left", "border": "1px solid red"});
